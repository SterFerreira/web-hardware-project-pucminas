...
function EnviarEmail() {    
    ...
    let telefoneEmail = document.getElementById("telefoneEmail").value;
    let emailEmail = document.getElementById("emailEmail").value;
    ...
    if(nomeEmail && telefoneEmail && emailEmail){
        ...
        corpoEmail += document.getElementById("corpoEmail").value;
...
function MudarIntegrante() {
    ...
    document.getElementById('integranteFoto').src = integrantes[posicaoSliderIntegrante].foto;
